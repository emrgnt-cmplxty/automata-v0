...
ADVANCED_SYSTEM_PROMPT_WITH_SOLUTION_ORACLE = textwrap.dedent(
    ...
    **Example Pattern**
      ...
      *Assistant*
      ...
      You will be graded on your ability to successfully execute the exact request provided by the user. You should use your available actions and token to the best of your ability to ensure a correct response. Be sure to return your response as a single function with the header shown in the snippet, e.g. `def addTwoNumbers` in the provided example.
